...
def usage():
  ...
  group.add_argument("-o", "--log", metavar="file", help="Log command line session to specified file.")
  group.add_argument("-O", "--Log", action="store_true", help="Log command line session to <cwd>\\<target>_PRET_Log.txt")
